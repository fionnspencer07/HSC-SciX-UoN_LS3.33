...
# ============================================================================
# 3. PSEUDOBULK ANALYSIS - BOTH COMPARISON TYPES
# ============================================================================

print("\n=== 3. PSEUDOBULK ANALYSIS ===")

# 3A. Pseudobulk for compartment comparisons (WB vs BM)
...
# 3B. Pseudobulk for condition comparisons within each compartment
...
for(comp_type in c("Compartment", "Condition_within_Compartment")) {
