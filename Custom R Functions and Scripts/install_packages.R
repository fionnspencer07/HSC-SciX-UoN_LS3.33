...
BiocManager::install("ComplexHeatmap", dependencies = TRUE) # or use github for latest vers- see github section below [devtools::install_github("jokergoo/ComplexHeatmap")]
